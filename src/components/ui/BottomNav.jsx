  ...
  return (
    <div className='fixed bottom-0 flex flex-row justify-evenly md:justify-center border-t-[#c4c3ff] px-5 gap-3 bg-white border-t-2 sm:w-[65vw] w-full h-20 md:h-15 '>
      ...
      <button 
        ...
        className={currentPage=='settings' ?  `items-center justify-center flex flex-col gap-1 cursor-pointer bg-[#5754E8] w-1/4 sm:w-15 text-white p-2 rounded-md my-1 transition duration-100 ease-in-out` : `items-center justify-center flex flex-col gap-1 cursor-pointer hover:bg-[#e7e7ff] w-1/4 sm:w-15 text-black p-2 rounded-md my-1 transition duration-100 ease-in-out` }
      >
